...
const Backdrop = ({ onClose }) => {
  return (
    <div
      onClick={onClose}
      className='top-0 left-0 fixed bg-black/20 backdrop-blur-md h-screen w-screen'></div>
  );
};
        ...
        {startDeploying ? (
          <div className='flex flex-col justify-center items-center gap-4'>
            ...
            {deploymentSuccess && (
              <button
                onClick={() => {
                  window.open(`https://ccip.chain.link/tx/${txhash}`, '_blank');
                }}
          ...
          <div>
            ...
            <>
              ...
              <input
                ...
                type='number'
                id='salt'
                onChange={(e) => setSalt(e.target.value)}></input>
